...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=20, save_best='mIoU', type='CheckpointHook'),
...
train_cfg = dict(max_iters=40000, type='IterBasedTrainLoop', val_interval=20)
...
work_dir = './changer_r18_levir_workdir_20'
