...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=10, save_best='mIoU', type='CheckpointHook'),
...
train_cfg = dict(max_iters=40000, type='IterBasedTrainLoop', val_interval=10)
...
work_dir = './changer_r18_levir_workdir_10'
